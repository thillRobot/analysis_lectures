...
\usepackage{/home/thill/Documents/lectures/analysis_lectures/exam_review/exam_review} 
 \newcommand{\EXAMNUM}{2}
...
%		\begin{itemize}
			...
			\item \color{blue}{{\bf*** You must submit one .pdf and one .m file for this exam. ***}}
%		\end{itemize}
\end{itemize}
