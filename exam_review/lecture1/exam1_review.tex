...
\item  \textbf{\Large Major Topics}\\
	...
	\large
		\item  \textbf{\Large Numerical Methods for Solving Non-Linear Equations }\\
			\begin{itemize}
			\item Incremental, Bisection, Newton-Raphson Methods
			\item General form of Problem\\
			\end{itemize}
		\item  \textbf{\Large System of Linear Equations }\\	
			\begin{itemize}
