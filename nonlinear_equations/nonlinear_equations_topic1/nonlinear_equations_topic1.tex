...
\newcommand{\sectiontitleII}{Solving Nonlinear Equations}
...
\frame{
  \frametitle{\sectiontitleII}
	...
	Example: 	\hspace{2mm}\scalebox{1.0}{$y = x^2 + 2x - 10$}	 \vspace{2mm}
		...
		\hspace*{-1cm}\includegraphics[scale=.45]{lecture1_fig1.png}  
...
\textbf{ Method 1 - {\it Algebra} }
			...
			\hspace*{-1cm}\includegraphics[scale=.4]{lecture1_fig3.png}
			\end{multicols}
