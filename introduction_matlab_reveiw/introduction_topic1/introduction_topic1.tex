...
\frame{
  \frametitle{\sectiontitleI}
  		...
  		Define {\it Analysis}: \\	
			- detailed examination of the elements or structure of something, typically as a basis for discussion or interpretation.  \vspace{5mm} \\ 
			
		
			
    \begin{itemize}
		
		\item Analysis \vspace{5mm}
...
\frame{
  \frametitle{\sectiontitleV}	
   \begin{enumerate}
					\item Mathematical Modeling \hspace{1mm} \vspace{3mm}\\
