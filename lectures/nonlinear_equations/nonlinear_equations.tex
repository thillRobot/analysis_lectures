...
\begin{document}
	...
	\section{\sectionItitle}\label{sectionI}
		...
		\subsection{\sectionIsubsectionIItitle}\label{sectionIsubsectionII}
			...
			\begin{frame}
				...
				\bigskip
					...
					\hspace*{-1cm}\includegraphics[scale=.45, alt={a graph of a quadratic polynomial}]{images/lecture1_fig1.png}  
		...
		\subsection{\sectionIsubsectionIIItitle}\label{sectionIsubsectionIII}
			\begin{frame} 
				...
				\textbf{Analytical}
				\begin{itemize}
					\item solution to a problem that can be written in {\bfseries closed form} 
					\item solution in terms of known functions, constants, etc.  
					\item gives an {\bfseries exact answer}  \vspcc
				\end{itemize}

				\textbf{Numerical}
				\begin{itemize}
					\item an {\bfseries  approximation} to the solution of a mathematical equation
		...
		\subsection{\sectionIsubsectionIVtitle}\label{sectionIsubsectionIV}	
			...
			\begin{frame}
				...
				\hspace*{-1cm}\includegraphics[scale=.4, alt={a zoomed in graph of a quadratic polynomial}]{images/lecture1_fig3.png}
				\end{multicols}
	...
	\section{\sectionIItitle}\label{sectionII}
		...
		\begin{frame}
			...
			\begin{itemize}
				...
				\item \hyperref[sectionIIsubsectionV]{\sectionIIsubsectionVtitle} \vspc % section II subsection V
				\item \hyperref[sectionIIsubsectionVI]{\sectionIIsubsectionVItitle} \vspc % section II subsection VI
			\end{itemize}
		...
		\subsection{\sectionIIsubsectionItitle}\label{sectionIIsubsectionI}
			...
			\begin{frame}
				...
				\begin{itemize}
					...
					\item leads to an exact or {\itshape analytical} solution \\ 	\vspace{10mm}
				\end{itemize}
				\textbf{ Numerical Solution Techniques }		
				\begin{itemize}
					\item  approximating the solution to the equation using varying methods, or {\itshape algorithms}  \\
					\item leads to a approximate solution \\ 
					\item a.k.a. {\itshape Numerical Method}\vspace{20mm}
				\end{itemize}
			...
			\begin{frame}
				...
				\includegraphics[scale=.17, alt={a portrait of Isaac Newton}]{images/newton_portrait.jpg}
				%\hspace{10mm}\includegraphics[scale=.30]{images/raphson_book.jpg}
				\hspace{10mm}\includegraphics[scale=.40, alt={a portrait of Joseph Raphson}]{images/Joseph-Raphson-1648-1715.png}
				\hspace{10mm}\includegraphics[scale=.30, alt={a portrait of Brook Taylor}]{images/BTaylor.jpg}
				\btVFill
			\end{frame}	
			...
			\begin{frame}
				...
				The Newton-Raphson method uses the slope at a point to approximate the solution. The process is repeated until the approximate solution meets a given tolerance. \vspace{5mm}

				\includegraphics[scale=.35, alt={an orthogonal axes set}]{images/topic3_fig1.png}
		...
		\subsection{\sectionIIsubsectionIItitle}\label{sectionIIsubsectionII}
			...
			\begin{frame}
				...
				The 4 possible sign (+/-) cases are handled by the algorithm. \vspace{3mm}\\

			%	Now you have much better hammer. However, must be used properly... \vspace{3mm}\\
				\includegraphics[scale=.35, alt={four orthogonal axes sets}]{images/topic3_fig2.png}
		...
		\subsection{\sectionIIsubsectionIIItitle}\label{sectionIIsubsectionIII}
			...
			\begin{frame}
				...
				\end{itemize}	
				\includegraphics[scale=.3, alt={four orthogonal axes sets}]{images/topic3_fig2.png}			
		...
		\subsection{\sectionIIsubsectionIVtitle}\label{sectionIIsubsectionIV}
			...
			\begin{frame}
				...
				\textbf{{\itshape Hint:} Think about the title \PR{secant} \BK ...} \vspace{10mm}\\
			...
			\begin{frame}
				...
				This idea or technique is the foundation of a family of methods known as the {\itshape \PR Finite Difference Methods}.

				\begin{multicols}{3}

					Forward\\
					Difference\\
					\includegraphics[scale=.14, alt={an orthogonal axes set}]{images/lecture4_fig1.png}\\
		...
		\subsection{\sectionIIsubsectionVtitle}\label{sectionIIsubsectionV}
			...
			\begin{frame}
				...
				\begin{multicols}{2}
				Newton-Raphson
				\includegraphics[scale=.22, alt={an orthogonal axes set}]{images/lecture4_fig1.png} 
				Secant
				\includegraphics[scale=.22, alt={an orthogonal axes set}]{images/lecture4_fig1.png}
				\end{multicols}
	...
	\section{\sectionIIItitle}\label{sectionIII}
		...
		\subsection{\sectionIIIsubsectionIItitle}\label{sectionIIIsubsectionII}	
			...
			\begin{frame}
				...
				The Bisection method is a {\itshape bracketing method}. \vspace{5mm}
				\includegraphics[scale=.40, alt={an orthogonal axes set}]{images/topic3_fig1.png}
	...
	\section{\sectionIVtitle}\label{sectionIV}
		...
		\begin{frame}
			...
			\begin{itemize}
				\item \hyperref[sectionIVsubsectionI]{\sectionIVsubsectionItitle} \vspc %  section IV subsection I
				\item \hyperref[sectionIVsubsectionII]{\sectionIVsubsectionIItitle} \vspc % section IV subsection II
				\item \hyperref[sectionIVsubsectionIII]{\sectionIVsubsectionIIItitle} \vspc % section IV subsection III
				\item \hyperref[sectionIVsubsectionIV]{\sectionIVsubsectionIVtitle} \vspc % section IV subsection IV
			\end{itemize}
		...
		\subsection{\sectionIVsubsectionItitle}\label{sectionIVsubsectionI}
			...
			\begin{frame}
				...
				What is the {\itshape  mathematical model} of the cone?  
		...
		\subsection{\sectionIVsubsectionIItitle}\label{sectionIVsubsectionII}
			...
			\begin{frame}
				...
				How are \underline{you} going to {\itshape design} the cone? \vspace{5mm}\\
				\includegraphics[scale=.35, alt={a schematic of a cone with dimension symbols}]{images/lecture3_fig1.png}\\
