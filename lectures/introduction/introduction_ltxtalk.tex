...
% Topic 3 - Hello World 
 ...
 % this does not work, might never work w Beamer :(
\DocumentMetadata{
  lang        = de,
  pdfstandard = ua-2,
...
\begin{document}
		...
		\begin{frame}
			...
			%\bigskip
         		...
         		\begin{multicols}{2}
           		...
           		Consider you are an engineer working on a robot. 
           		\begin{itemize}
				\item Analysis %\vspace{15mm}
				\item Design 
			\end{itemize}  
          		%\vspace*{5mm}
				\includegraphics[scale=0.04, alt={a photograph of a cobot welding machine}]{images/switchweld_robot_clutter.png}
			\end{multicols}
          		\btVFill
		\end{frame}
	...
	\subsection{\sectionIsubsectionIItitle}\label{sectionIsubsectionII}
		...
		\begin{frame}
			...
			\begin{itemize}
				...
				\item we can solve thelarge{BIG} problems!
			\end{itemize}  
	...
	\subsection{\sectionIsubsectionIIItitle}\label{sectionIsubsectionIII}
		\begin{frame} 
			...
			We will be doing some {\itshape applied mathematics} in this class!
			\begin{multicols}{2}
			\begin{itemize}
		...
		\subsection{\sectionIIsubsectionItitle}\label{sectionIIsubsectionI}
			...
			\begin{frame}
				...
				\begin{itemize}
					...
					\end{itemize}
					\item {\itshape MAT}rix {\itshape LAB}oratory
					\item {\itshape Technical Computing Language} - Mathworks
				\end{itemize}	
			...
			\begin{frame}
				...
				%\bigskip
					...
					\begin{itemize}	
						...
						\end{multicols}
						\end{itemize}
						\item ability to use {\itshape symbolic programming }	
					\end{itemize}
					
					\item Ease of Access and Community
					\begin{itemize}
						\item {\itshape Plug and Play}, itshape works out of the box
						\item requires no programming experience to begin
						\item online community for sharing code,  {\itshape MATLAB Central}
					\end{itemize}
				\end{itemize}
	...
	\section{\sectionIIItitle}\label{sectionIII}
		...
		\subsection{\sectionIIIsubsectionItitle}\label{sectionIIIsubsectionI}
			...
			\begin{frame}
				...
				\begin{itemize}
					...
					\item  In MATLAB a program is referred to as a {\itshape script}	
				\end{itemize}
		...
		\subsection{\sectionIIIsubsectionIItitle}\label{sectionIIIsubsectionII}	
			...
			\begin{frame}
				...
				\begin{enumerate}
					\item Open the {\bfseries  MATLAB} application.
					\item In the {\itshape Editor} window. Click on the {\bfseries  new } Button. Go down to {\bfseries  script}.
					\item Write a proper {\bfseries  header} at the top of your script. Make sure to include your {\itshape Name}, the {\itshape Date}, the {\itshape Course}, and a {\itshape Description} of this program.
					\item In the {\itshape Editor} window. Click on the {\bfseries  save} button. Now you will need to name your file and save it in your directory structure.
					\item Now you are going to start {\bfseries  writing} your first program. 
					\item {\bfseries  Run} your program and {\itshape  watch the magic}!
				\end{enumerate}
		...
		\subsection{\sectionIIIsubsectionIIItitle}\label{sectionIIIsubsectionIII}
			...
			\begin{frame}
				...
				\textbf{Step 1} - Open the {\bfseries  MATLAB} application.
			...
			\begin{frame}
				...
				%\bigskip
%
				\textbf{Step 2} - In the {\itshape  Editor} window. Click on the {\bfseries  new } Button. \vspace{3mm}\\ \hspace*{12mm}Go down to {\bfseries  script}
			...
			\begin{frame}
				...
				\textbf{Step 3} - Write a proper {\bfseries  header} at the top of your script. \vspace{3mm}\\ Make sure to include your {\itshape  Name}, the {\itshape  Date}, the {\itshape  Course}, and a {\itshape  Description} of this program.
			...
			\begin{frame}
				...
				\textbf{Step 4} - In the {\itshape  Editor} window. Click on the {\bfseries  save} button. \vspace{3mm}\\ Now you will need to name your file and save it in your directory structure.
			...
			\begin{frame}
				...
				\textbf{Step 5} - Now you are going to start {\bfseries  writing} your first program. \vspace{3mm}\\ Make sure you are in the {\itshape Editor} window.
			...
			\begin{frame}
				...
				\textbf{Step 6} - {\bfseries Run} your program and {\itshape  watch the magic}!
